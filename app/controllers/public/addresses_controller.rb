class Public::AddressesController < ApplicationController
  before_action :authneticate_customer!
  ...
  def update
    @address.update(address_parmas) ? (redirect_to addresses_path) : (render :edit)
  end
  ...
  def address_params
    params.require(:address).permit(:potal_code, :destination, :name)
  end
